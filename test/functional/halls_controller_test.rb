...
class HallsControllerTest < ActionController::TestCase
  ...
  test "should create hall" do
    assert_difference('Hall.count') do
      post :create, hall: { hall_rent: @hall.hall_rent, name: @hall.name, pricing_mode: @hall.pricing_mode, type: @hall.type }
    end
  ...
  test "should update hall" do
    put :update, id: @hall, hall: { hall_rent: @hall.hall_rent, name: @hall.name, pricing_mode: @hall.pricing_mode, type: @hall.type }
    assert_redirected_to hall_path(assigns(:hall))
  end
